...
const PostRequestEditLocation = () => {
  ...
  const handleLocationSelect = (data, details) => {
    ...
    navigation.navigate(routes.PostRequest, {
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.autocompleteContainer}>
        <GooglePlacesAutocomplete
          placeholder={t('postrequest.selectLocation')} // Translation for location placeholder
...
export default PostRequestEditLocation;
