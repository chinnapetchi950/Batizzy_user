...
const UserProfile = () => {
  ...
  const GetSocialPostList = useCallback(async () => {
    ...
    try {
      ...
      const response = await fetch(`${baseURL}posts_by_user`, {
        method: 'GET',
        headers: {
          Authorization: `Bearer ${Token}`,
          Accept: 'application/json',
    ...
    <View style={styles.wrapper}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
            ...
            <Image
              source={
                isuserData && isuserData.profile_image
                  ? {uri: uploads_url + isuserData.profile_image}
                  : icons.dummyUser
              }
              style={styles.profileImage}
            />
            {/* <Pressable style={styles.cameraIconWrapper}>
              <Image
                resizeMode="contain"
        ...
        <Pressable
          ...
          onPress={() => {
            navigation.navigate(routes.ProfileFollowerList);
          }}>
          <Image
            resizeMode="contain"
        ...
        <View style={styles.infoRow}>
          ...
          {/* <Pressable>
            <Image
              resizeMode="contain"
              source={icons.editPencilBlue}
              style={styles.editPencilBlueIcon}
            />
          </Pressable> */}
        </View>
